...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
	...
	useRouteMatch is used for any time you want to render a route outside of a switch - or if you are just trying to get use of its match data.It uses the same exact, strict and sensitive options a route would.

2. How would you explain form validation to someone who has never programmed before?

	Form validation is simply a way to ensure the user is inputting the correct data within the parameters given.

3. In 1-2 sentences, define end to end testing.

	End-to-end testing is ensuring the flow of an app from start to finish is operating like it was intended. 
