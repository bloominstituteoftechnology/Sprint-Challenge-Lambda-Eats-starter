...
The useRouteMatch hook is used to extract the match data from the route. You can get parameters like the path and url to use in your links. 

2. How would you explain form validation to someone who has never programmed before?
Form validation is the process of giving certain desired values to your inputs and making sure that the user has met 
those requirements such as a minimum length for a password or making sure the email has an @ symbol.

3. In 1-2 sentences, define end to end testing.
End to end testing tests your entire user experience by simulating events such as typing information into inputs and clicking buttons to see if users can accomplish each action. 
