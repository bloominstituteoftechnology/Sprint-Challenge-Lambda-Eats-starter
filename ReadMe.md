...
The useRouteMatch hook matches the current URL in the same way a Route would. It’s useful for gaining access to the match data without actually rendering a Route.

2. How would you explain form validation to someone who has never programmed before?

Validation is what communicates to the user what type of information a form needs in order to function properly and keeps all other data from being entered that might break the code. It is also a good reminder if any required fields are left blank.

3. In 1-2 sentences, define end to end testing.

End to end testing ensures the code integrity is maintained between all the system components in an application from start to finish.
