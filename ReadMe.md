...
form validation is used to make sure any required fields are filled out.

3. In 1-2 sentences, define end to end testing.

End to end testing is where we can use libraries like cypress to test our forms to know that they are working correctly. We can program tests from one end of our code to the other, to ensure all is good.
