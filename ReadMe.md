...
useRouteMatch lets you add nested routes to your application such that you can change a single parameter in the URL without having to change the whole thing. That way, you can have multiple versions of a page with one url.

2. How would you explain form validation to someone who has never programmed before?

You know when you try to make your password “password” and the form tells you to chose a stronger password? That’s called validation.
